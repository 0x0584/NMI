...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[CustomerCustomerDemo] DROP CONSTRAINT [DF_CustomerCustomerDemo_LastEditDate]
GO
IF @@ERROR <> 0 
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[CustomerCustomerDemo] DROP COLUMN [LastEditDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[CustomerCustomerDemo] DROP CONSTRAINT [DF_CustomerCustomerDemo_CreationDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
...
IF @@TRANCOUNT > 0
ALTER TABLE [dbo].[CustomerCustomerDemo] DROP COLUMN [CreationDate]
GO
IF @@ERROR <> 0 
     ROLLBACK TRANSACTION;
...
IF @@TRANCOUNT > 0
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CustomerCustomerDemo_Tombstone]') and TYPE = N'U') 
   DROP TABLE [dbo].[CustomerCustomerDemo_Tombstone];
